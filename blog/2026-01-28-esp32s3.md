...
Bike GPS with esp32s3 and in the future support c6.
{/* truncate */}
### Install IDF
...
### Tips on Linux
In some Linux distro, you may have no permission to flash program to esp32, `ls -l /dev/tty*` to check the permission and ownership of `ttyACM0`, `ttyUSB0`
the device may have some other similar names.

Solutions:

- Change permission temporarily
...
Extensions are all you need. `ESP-IDF`, `clangd` or `C/C++`, `CMake Tools`
